...
class TranslatorsControllerTest < ActionController::TestCase
  ...
  test "should create translator" do
    assert_difference('Translator.count') do
      post :create, translator: { email: @translator.email, firstname: @translator.firstname, lastname: @translator.lastname }
    end
  ...
  test "should update translator" do
    patch :update, id: @translator, translator: { email: @translator.email, firstname: @translator.firstname, lastname: @translator.lastname }
    assert_redirected_to translator_path(assigns(:translator))
  end
